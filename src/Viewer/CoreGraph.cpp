...
void CoreGraph::reload(Data::Graph * graph)
{
    ...
    osg::ref_ptr<osg::MatrixTransform> geom1 = new osg::MatrixTransform(osg::Matrixd::scale(osg::Vec3f(0.2,0.1,0.2)));
    ...
    dragger->addChild (restrictionVisualizationsGroup->getGroup ());
